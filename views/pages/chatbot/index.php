...
?>
    ...
    <div class="content my-3" >
      <section class="chat-area border border-success-subtle p-2">
        <header class="row d-flex align-items-center">
          ...
          ?>
          <div class="col-2">
            <a href="index.php" class="black-icon"><i class="fa-solid fa-arrow-left"></i></a>
          </div>
          <div class="col-10 d-flex flex-row-reverse ">
            ...
            <div class="details">
              ...
              <p class="<?php echo ($row['status'] == 'Online') ? 'text-success' : 'text-danger'?>"><?php echo $row['status']; ?></p>
            </div>
          </div>
          <?php } ?>
        </header>
