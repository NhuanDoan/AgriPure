    ...
    fetch(url)
        ...
        .then(data => {
            if (data.display_name) {
                ...
                document.getElementById('farm_address').value = address;
            } else {
                document.getElementById('farm_address').value = "Không tìm thấy địa chỉ";
            }
        })
        .catch(error => {
            console.error("Lỗi khi lấy địa chỉ:", error);
            document.getElementById('farm_address').value = "Lỗi khi lấy địa chỉ";
        });
}
